...
```shell
./build_opencv.sh 4.1.0
```

Where `4.1.0` is any version of openCV from 2.2 to 4.4.0
...
OpenCV 4.4.0 somehow is problematic and spaming errors during building. Recomended to use OpenCV 4.1.0